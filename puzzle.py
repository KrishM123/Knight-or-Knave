...
knowledge2 = And(
    ...
    Not(And(AKnight, AKnave)),
    Not(And(BKnight, BKnave)),
    Biconditional(Or(Biconditional(AKnight, BKnight), Biconditional(AKnave, BKnave)), AKnight),
    Biconditional(Or(Biconditional(AKnave, BKnight), Biconditional(AKnight, BKnave)), BKnight)
)
